...
struct mobdb_data {
	...
	int vita, exp, type, subtype, look, look_color, hit, level, might, grace, will, movetime, atktime, spawntime, baseac, mrespawnfunc;
...
struct mobspawn_data {
    ...
    int ac, side, time, spawncheck, num, crit, critchance, critmult, snare, lastaction, hit, might, grace, will, physdeduct, mrespawnfunc, sound;
...
struct map_sessiondata {
	...
	unsigned int max_hp, max_mp, attacker, rangeTarget, equipid, breakid, pvp[20][2], killspvp, timevalues[5], lastvita, groupid, disptimer, disptimertick, helper;
