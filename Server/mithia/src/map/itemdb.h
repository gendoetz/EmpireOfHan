...
struct item_data {
	...
	int might_req, grace_req, will_req, depositable, exchangeable, droppable, thrown, unique, dodge, parry, block, resist, vregen, mregen, physdeduct, allowdye, breakondeath;
