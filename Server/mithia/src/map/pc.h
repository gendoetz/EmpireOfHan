...
int pc_additem_unequip(USER*,struct item*);
...
int pc_getitemscript2(USER*,int);
...
int pc_isinvenspace(USER*,int,int,int,char*);
int pc_isinvenspace_unequip(USER*,int,int,int,char*);
int pc_isinvenitemspace(USER*,int,int,int,int,char*);
