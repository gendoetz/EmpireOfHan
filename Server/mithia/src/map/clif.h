...
int clif_lookgoneWarp(struct block_list*);
...
int clif_parserefresh_ctrlr(USER*);
...
int clif_accept(int);
int clif_parse(int);
int clif_scriptmenu(USER*, unsigned int, char*,char*[],int);
int clif_scriptmenuseq(USER*, unsigned int, char*,char*[],int,int,int);
