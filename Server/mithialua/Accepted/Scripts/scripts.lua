...
onCreation = function(player)
	...
	for x = 1, #items do
		if (Item(items[x]).id == 417 and itemamounts[x] == 1) then --This is an acorn
			slot1 = 417
		end
		if (Item(items[x]).id == 418 and itemamounts[x] == 1) then
			slot2 = 418
		end
		if (Item(items[x]).id == 419 and itemamounts[x] == 1) then
			slot3 = 419
		end

		--Event creation item necklaces
		if (Item(items[x]).id == 436 and itemamounts[x] == 20) then
			slot1 = 436
		end
		if (Item(items[x]).id == 437 and itemamounts[x] == 20) then
			slot1 = 437
		end
		if (Item(items[x]).id == 438 and itemamounts[x] == 20) then
			slot1 = 438
		end
		if (Item(items[x]).id == 439 and itemamounts[x] == 20) then
			slot1 = 439
		end

		if (Item(items[x]).id == 190 and itemamounts[x] == 10) then
			slot2 = 190
		end

		if (Item(items[x]).id == 412 and itemamounts[x] == 5) then
			slot3 = 412
		end

--Breathing mask

		if (Item(items[x]).id == 50027 and itemamounts[x] >= 24) then
			slot1 = 50027
		end
		if (Item(items[x]).id == 40061 and itemamounts[x] >= 3) then
			slot2 = 40061
		end
		if (Item(items[x]).id == 40205 and itemamounts[x] >= 2) then
			slot3 = 40205
		end
		if (Item(items[x]).id == 40023 and itemamounts[x] >= 1) then
			slot4 = 40023
		end
...
--- End Breathing mask
	...
	if (slot1 == 50027 and slot2 == 40061 and slot3 == 40205 and slot4 == 40023) then
		player:removeItem("flower_elecampane", 24)
		player:removeItem("branch_elm", 3)
		player:removeItem("fibre_wool", 2)
		player:removeItem("fighter_25h", 1)

		player:addItem("breathing_mask", 1)
	elseif (slot1 == 417 and slot2 == 418 and slot3 == 419) then
		player:removeItem("tvain1", 1)
		player:removeItem("tvain2", 1)
		player:removeItem("tvain3", 1)

		player:addItem("thornvain1", 1)
		--player:talk(0,"Item test:"..Item(items[1]).id.." and "..itemamounts[1])
		--player:talk(0,"Item test:"..Item(items[2]).id.." and "..itemamounts[2])
		--player:talk(0,"Item test:"..Item(items[3]).id.." and "..itemamounts[3])
	else
		player:sendMinitext("Nothing happens.")
	end

  	if (slot1 == 436 and slot2 == 190 and slot3 == 412) then
  		player:removeItem("warrior_sevent", 20)
		player:removeItem("wool", 10)
		player:removeItem("owldust", 5)
		player:addItem("warrior_necklace", 1)
	end
	if (slot1 == 437 and slot2 == 190 and slot3 == 412) then
  		player:removeItem("rogue_sevent", 20)
		player:removeItem("wool", 10)
		player:removeItem("owldust", 5)
		player:addItem("rogue_necklace", 1)
	end
	if (slot1 == 438 and slot2 == 190 and slot3 == 412) then
  		player:removeItem("mage_sevent", 20)
		player:removeItem("wool", 10)
		player:removeItem("owldust", 5)
		player:addItem("mage_necklace", 1)
	end
	if (slot1 == 439 and slot2 == 190 and slot3 == 412) then
  		player:removeItem("poet_sevent", 20)
		player:removeItem("wool", 10)
		player:removeItem("owldust", 5)
		player:addItem("poet_necklace", 1)
	end
end
