...
click = function(player, npc)
	...
	local sG_CoatM = {graphic = convertGraphic(4267, "item"), color = 23}
	local sG_CoatF = {graphic = convertGraphic(4268, "item"), color = 23}
	local sG_Weapon = {graphic = convertGraphic(1176, "item"), color = 1}
	...
	local subCM_Name = "Ivory Plate"
	local subCM_NameY = "subcoat_knightM"
	local subCF_Name = "Ivory Plate Dress"
	local subCF_NameY = "subcoat_knightF"
	local subW_Name = "Last Rites"
	local subW_NameY = "knight_99w"
	local subS_Name = "Mirrored Shield"
	local subS_NameY = "knight_99s"
