...
click = function(player, npc)
	...
	local sG_CoatM = {graphic = convertGraphic(4271, "item"), color = 6}
	local sG_CoatF = {graphic = convertGraphic(4272, "item"), color = 6}
	local sG_Weapon = {graphic = convertGraphic(1182, "item"), color = 0}

	local subCoat = player.quest["subitem_Coat"]
	local subWeapon = player.quest["subitem_Weapon"]

	local className = "Elementalist"

	local subCM_Name = "Frostfire Raiment"
	local subCM_NameY = "subcoat_elementalistM"
	local subCF_Name = "Frostfire Raiment Dress"
	local subCF_NameY = "subcoat_elementalistF"
	local subW_Name = "Elemental Spire"
	local subW_NameY = "elementalist_99w"
	...
	-- Sacrifices
		...
		-- Weapon
		local subW_ItemA = "Dreambender"
		local subW_ItemAy = "mage_95w"
