...
click = function(player, npc)
	...
	local sG_CoatM = {graphic = convertGraphic(3059, "item"), color = 0}
	local sG_CoatF = {graphic = convertGraphic(3060, "item"), color = 0}
	local sG_Weapon = {graphic = convertGraphic(2513, "item"), color = 5}

	local subCoat = player.quest["subitem_Coat"]
	local subWeapon = player.quest["subitem_Weapon"]

	local className = "Bard"

	local subCM_Name = "Minstrel's Costume"
	local subCM_NameY = "subcoat_bardM"
	local subCF_Name = "Minstrel's Costume Dress"
	local subCF_NameY = "subcoat_bardF"
	local subW_Name = "Maelstrom"
	local subW_NameY = "bard_99w"
	...
	-- Sacrifices
		...
		-- Weapon
		local subW_ItemA = "Lifebender"
		local subW_ItemAy = "poet_95w"
