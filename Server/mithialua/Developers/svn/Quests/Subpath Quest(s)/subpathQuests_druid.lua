...
click = function(player, npc)
	...
	local sG_CoatM = {graphic = convertGraphic(3036, "item"), color = 70}
	local sG_CoatF = {graphic = convertGraphic(3039, "item"), color = 65}
	local sG_Weapon = {graphic = convertGraphic(2509, "item"), color = 26}
	...
	local subCM_Name = "Life-thread Robe"
	local subCM_NameY = "subcoat_druidM"
	local subCF_Name = "Life-thread Gown"
	local subCF_NameY = "subcoat_druidF"
	local subW_Name = "Coiled Branch"
	local subW_NameY = "druid_99w"
