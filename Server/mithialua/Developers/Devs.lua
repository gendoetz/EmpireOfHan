...
function Player.staff(player, str, int)
	local loreTable = {charIDs = {2, 3, 57}, charLevels = {5, 5, 5}}
	local mapTable = {charIDs = {2, 3, 57}, charLevels = {5, 5, 5}}
	local scriptTable = {charIDs = {2, 3, 57}, charLevels = {5, 5, 5}}
	local projectManagerTable = {charIDs = {2, 3, 57}, charLevels = {5, 5, 5}}
	local accessLevel = -1
